...
ARK_API_KEY. It also requires the project-4 `llmops_dashboard` LLMTracer to be
importable (the real clients refuse to run without it). It is deliberately NOT
...
def main() -> int:
    ...
    print(f"Connectivity smoke test — trace_id={trace_id}\n")
